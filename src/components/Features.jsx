      ...
      <div className="card  bg-black w-96 shadow-xl  ">
        ...
        <div className="card-body border-neutral-900 border-2 rounded-b-xl">
          <div className="relative isolate px-6 ">
            ...
            <p>
              Experience lightning-fast transactions on rhino.fi, ensuring your
              assets move across chains swiftly and securely. Our platform's
              speed is matched only by its robust security measures.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="card-body border-neutral-900 border-2 rounded-b-xl">
          <div className="relative isolate px-6 ">
            ...
            <p>
              ...
              DeFi. Our fee model reflects this to support all users to make the
              most of DeFi.
            </p>
          </div>
        </div>
